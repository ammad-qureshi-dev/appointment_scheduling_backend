...
public class ServicesController {
    ...
    public ResponseEntity<ServiceResponse<Boolean>> addService(@PathVariable UUID companyId, @RequestBody List<ServiceRequest> request) {
        try {
    ...
    public ResponseEntity<ServiceResponse<Boolean>> removeService(@PathVariable UUID companyId, @RequestBody SimpleServiceRequest request) {
        try {
    ...
    public ResponseEntity<ServiceResponse<Boolean>> updateService(@PathVariable UUID companyId, @RequestBody ServiceRequest request) {
        try {
