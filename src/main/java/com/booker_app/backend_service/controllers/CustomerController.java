...
public class CustomerController {
    ...
    public ResponseEntity<ServiceResponse<UUID>> addCustomer(@PathVariable("companyId") UUID companyId, @RequestBody CustomerRequest request) {
        try {
    ...
    public ResponseEntity<ServiceResponse<List<CustomerDTO>>> findAllCustomers(@PathVariable("companyId") UUID companyId) {
        try {
    ...
    public ResponseEntity<ServiceResponse<Boolean>> deleteCustomer(@PathVariable("companyId") UUID companyId, @RequestBody CustomerRequest request) {
        try {
