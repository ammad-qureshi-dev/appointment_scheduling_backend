...
public enum ResponseType {
	USER_ALREADY_EXISTS("User already exists"), SERVICE_ALREADY_EXISTS("Service already exists"), CANNOT_REMOVE_OWNER(
			"User has role-type of OWNER, cannot remove"), USER_NOT_FOUND("User not found"), UNREGISTERED_USER_EMAIL(
