...
public class AuthController {
    ...
    @PostMapping("/login")
    private ResponseEntity<ServiceResponse<UUID>> login(@RequestBody LoginRequest loginRequest, HttpServletResponse response) {
        try {
    ...
    private ResponseEntity<ServiceResponse<UUID>> switchRole(@PathVariable UUID userId, HttpServletResponse response, @PathVariable UserRole role) {
        try {
